...
NL2PY_PROMPT = """
  ...
  **Data in prompt:** Take data for visualization from {query_execution_output}. You have to parse that data into a pandas DataFrame. ALWAYS parse all the data. NEVER edit the data that are given to you.
