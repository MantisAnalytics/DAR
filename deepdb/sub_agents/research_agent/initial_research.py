...
initial_research_agent = LlmAgent(
    ...
    instruction="""
        ...
        1. **Research Findings Section**
           - All Phase 1 [RESEARCH] summaries, clearly labeled
           - Organized by research goal with preservation of all details
        ...
        - 100% completion rate of all research and deliverable goals
        ...
        Remember: You are a trusted intelligence professional. Your credibility depends on absolute accuracy, systematic methodology, and transparent communication of what is known, assessed, and unknown.
        """,
